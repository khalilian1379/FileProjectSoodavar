...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    (t = document.getElementById("form-add-new-record")),
            ...
            e &&
                e.addEventListener("click", function () {
                    (offCanvasEl = new bootstrap.Offcanvas(t)),
                        ...
                        (t.querySelector(".dt-type_get").value = ""),
        ...
        (fv = FormValidation.formValidation(t, {
            fields: {
                basicTitlet: { validators: { notEmpty: { message: "لطفا عنوان دریافتی را وارد کنید" } } },
                basicType_get: { validators: { notEmpty: { message: "لطفا نوع دریافتی را وارد کنید" } } },
                basicDate: { validators: { notEmpty: { message: "لطفا تاریخ دریافتی را وارد کنید" }, date: { format: "YYYY/MM/DD", message: "تاریخ وارد شده نامعتبر است" } } },
                basicSalary: { validators: { notEmpty: { message: "لطفا مبلغ دریافتی را وارد کنید" } } },
            },
            plugins: {
    ...
    $(function () {
        var l,
            ...
            r =
                (e.length &&
                    ((l = e.DataTable({
                        "ordering": false,
                        columns: [{ data: "" }, { data: "" }, { data: " " }, { data: "title_t" }, { data: "type_get" }, { data: "start_date" }, { data: "salary" }, { data: "" }, { data: "" }],
                        columnDefs: [
                            {
                                className: "control",
                                orderable: !1,
                    ...
                    $("div.head-label").html('<h5 class="card-title mb-0">جدول ثبت درآمد</h5>')),
                101);
        fv.on("core.form.valid", function () {
            var e = $(".add-new-record .dt-title_t").val(),
                t = $(".add-new-record .dt-type_get").val(basicType_get),
                s = $(".add-new-record .dt-date").val(),
                n = $(".add-new-record .dt-salary").val();
            "" != e && (l.row.add({ id: r, title_t: e, type_get: t, start_date: s, salary: n + " تومان" }).draw(), r++, offCanvasEl.hide());
        }),
            ...
            a.length &&
                a.DataTable({
                    columns: [{ data: "title_t" }, { data: "type_get" }, { data: "" }, { data: "salary" }, { data: "" }, { data: "" }],
            ...
            s.length &&
                ((t = s.DataTable({
                    columns: [{ data: "" }, { data: "title_t" }, { data: "type_get" }, { data: "" }, { data: "start_date" }, { data: "salary" }, { data: "" }, { data: "" }],
                    columnDefs: [
                        {
                            className: "control",
                            orderable: !1,
        ...
        n.length &&
            n.DataTable({
                columns: [{ data: "" }, { data: "title_t" }, { data: "type_get" }, { data: "start_date" }, { data: "salary" }, { data: "" }, { data: "" }],
                columnDefs: [
                    {
                        className: "control",
                        orderable: !1,
