...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    (t = document.getElementById("form-add-new-record")),
            ...
            e &&
                e.addEventListener("click", function () {
                    (offCanvasEl = new bootstrap.Offcanvas(t)),
                        ...
                        (t.querySelector(".dt-type_bill").value = ""),
        ...
        (fv = FormValidation.formValidation(t, {
            fields: {
                basicTitlet: { validators: { notEmpty: { message: "لطفا عنوان قبض را وارد کنید" } } },
                basicType_bill: { validators: { notEmpty: { message: "لطفا نوع قبض را وارد کنید" } } },
                basicDate: { validators: { notEmpty: { message: "لطفا تاریخ پرداخت قبض را وارد کنید" }, date: { format: "YYYY/MM/DD", message: "تاریخ وارد شده نامعتبر است" } } },
                basicSalary: { validators: { notEmpty: { message: "لطفا مبلغ قابل پرداخت قبض را وارد کنید" } } },
            },
            plugins: {
    ...
    $(function () {
        var l,
            ...
            r =
                (e.length &&
                    ((l = e.DataTable({
                        "ordering": false,
                        columns: [{ data: "" }, { data: "" }, { data: " " }, { data: "title_t" }, { data: "type_bill" }, { data: "start_date" }, { data: "salary" }, { data: "" }, { data: "" }],
                        columnDefs: [
                            {
                                className: "control",
                                orderable: !1,
                        ...
                        buttons: [
                            ...
                            { text: '<i class="bx bx-plus me-sm-2"></i> <span class="d-none d-sm-inline-block">افزودن قبض</span>', className: "create-new btn btn-primary" },
                        ],
                        responsive: {
                            details: {
                    ...
                    $("div.head-label").html('<h5 class="card-title mb-0">جدول ثبت قبض</h5>')),
                101);
        fv.on("core.form.valid", function () {
            var e = $(".add-new-record .dt-title_t").val(),
                t = $(".add-new-record .dt-type_bill").val(basicType_bill),
                s = $(".add-new-record .dt-date").val(),
                n = $(".add-new-record .dt-salary").val();
            "" != e && (l.row.add({ id: r, title_t: e, type_bill: t, start_date: s, salary: n + " تومان" }).draw(), r++, offCanvasEl.hide());
        }),
            ...
            a.length &&
                a.DataTable({
                    columns: [{ data: "title_t" }, { data: "type_bill" }, { data: "" }, { data: "salary" }, { data: "" }, { data: "" }],
            ...
            s.length &&
                ((t = s.DataTable({
                    columns: [{ data: "" }, { data: "title_t" }, { data: "type_bill" }, { data: "" }, { data: "start_date" }, { data: "salary" }, { data: "" }, { data: "" }],
                    columnDefs: [
                        {
                            className: "control",
                            orderable: !1,
        ...
        n.length &&
            n.DataTable({
                columns: [{ data: "" }, { data: "title_t" }, { data: "type_bill" }, { data: "start_date" }, { data: "salary" }, { data: "" }, { data: "" }],
                columnDefs: [
                    {
                        className: "control",
                        orderable: !1,
