                        ...
                        var n = (function () {
                                ...
                                return (
                                            ...
                                            (s = function (e, t) {
                                                ...
                                                (t = function (t, n, i, r) {
                                                    var o,
                                                        ...
                                                        $ = [],
                                                        A = typeof i;
                                                    if (((m = b((r = r || t))), "undefined" === A || "function" === A)) {
                                                        for (n = !n.length && i.length ? ["require", "exports", "module"] : n, f = 0; f < n.length; f += 1)
                                                            if ("require" === (u = (h = s(n[f], m)).f)) $[f] = a.require(t);
                                                            else if ("exports" === u) ($[f] = a.exports(t)), (w = !0);
                                                            else if ("module" === u) o = $[f] = a.module(t);
                                                            else if (g(l, u) || g(c, u) || g(d, u)) $[f] = _(u);
                                                            else {
                                                                if (!h.p) throw new Error(t + " missing " + u);
                                                                h.p.load(h.n, v(r, !0), y(u), {}), ($[f] = l[u]);
                                                            }
                                                        (p = i ? i.apply(l[t], $) : void 0), t && (o && o.exports !== e && o.exports !== l[t] ? (l[t] = o.exports) : (p === e && w) || (l[t] = p));
                                                    } else t && (l[t] = i);
                                                }),
                                                (i = r = n = function (i, r, o, l, c) {
                                                    if ("string" == typeof i) return a[i] ? a[i](r) : _(s(i, b(r)).f);
                                                    if (!i.splice) {
                                    ...
                                    n.define(
                                        ...
                                        function (e, t, n, i, r, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, w, b, $, A, x, D, S, C, E) {
                                            function O() {
                                                this.reset();
                                            }
                                            return (
                                    ...
                                    "function" == typeof n.define && n.define.amd ? n.define("jquery-mousewheel", ["jquery"], s) : (e.exports = s),
